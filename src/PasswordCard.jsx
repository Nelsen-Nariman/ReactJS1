            ...
            <div className="card-body">
                <div className="content">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <button id="btn-edit" className={` btn ${isEdit ? "btn-success" : "btn-secondary"} `} onClick={
                            function(){
                                setIsEdit(!isEdit);
                                setIsShowPassword(false);
                                setTime(0)
...

                    {
                        ...
                        <React.Fragment>
                            <div id="username">username : {username}</div>
                             <div id="password">password : { isShowPassword ? password : PASSWORD_PLACEHOLDER}</div>
                        </React.Fragment> : 
                ...
                <div className="d-flex justify-content-between align-items-center mt-3">
                    <button id="btn-pass" className={` btn ${isShowPassword ? "btn-danger" : "btn-info"} `} onClick={()=>{
